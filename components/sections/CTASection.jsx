          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-stretch max-w-2xl mx-auto">
            ...
            >
              ...
              <div className="text-left">
                <div className="text-xs text-[#88939D] mb-1 group-hover:text-[#00FF94] transition-colors duration-300">Pošaljite email</div>
            ...
            >
              ...
              <div className="text-left">
                <div className="text-xs text-[#88939D] mb-1 group-hover:text-[#00FF94] transition-colors duration-300">Nazovite nas</div>
                <div className="text-white font-semibold group-hover:text-[#00FF94] transition-colors duration-300">
                  +385 91 546 9266
                </div>
              </div>
