...
export const COMPANIES = {
  progmatiq: {
    ...
    oib: '50299147291',
    signatory: 'Bruno Cukic'
  },
  endemik: {
    id: 'endemik',
    name: 'ENDEMIK, obrt za usluge, vl. Petar Zirdum',
    address: 'Ulica Anke Krizmanić 10, 10360 Sesvete, Croatia',
    email: 'hello@ninefold.eu',
    phone: '+385913333447',
    website: 'www.ninefold.eu',
    oib: 'HR36707764112',
    electronicAddress: '36707764112',
    idScheme: '9934',
    signatory: 'Petar Zirdum'
  }
};

export function getCompany(companyId) {
  return COMPANIES[companyId] || COMPANIES.progmatiq;
}
