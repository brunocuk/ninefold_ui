...
- **Semrush runda 2** (sve u memoriji `hr-keyword-data`):
  - **SEO klaster je najveća content prilika dosad**: seo optimizacija web stranice 1.900/mj KD 13, **cijena seo optimizacije 1.000/mj KD 5**, seo optimizacija cijena 720 KD 7, što je seo optimizacija 720 KD 9... ukupno ~7k/mj s KD ispod 20
  - **SERP dokaz da blog može na head term**: na "izrada web stranica" (3.600/mj) poz. 2 drži metadigitalov članak "koliko košta izrada web stranice, vodič za 2026" s **2 ref domene**, a poz. 6 webflareov cjenovni blog s **0 backlinkova**. Naš cjenovni članak treba "vodič za 2026" osvježenje
  - **Globaldizajnov content marketing je mit**: njihov promet su brand imena klijenata + gov.hr stranice na njihovim subdomenama; autoritet im dolazi iz klijentskih footera (gov.hr 1.227 linkova, kgz.hr 8.103), znači naš backlink blitz je bio točno njihova formula. Jedini pravi informativni win im je "mobilne aplikacije" (8,1k/mj KD 13)
  - **Backlink Gap** (vs globaldizajn/insertioweb/webdizajnrijeka/adesign): dohvatljivi prospekti DesignRush (AS 60, insertioweb odande ima 33 linka!), GoodFirms, Crunchbase, topseos; PR mete netokracija/bug.hr/geek.hr
  - Ostalo: domena klaster pristojan (hr domena 1.000 KD 24), google oglasi / izrada aplikacija / logo sitni; naš napredak 118 ref domena (+24%), 540 backlinkova (+16%), AS još 2
  - Content roadmap u `seo-next-steps`: 1) "Koliko košta SEO optimizacija", 2) SEO pillar, 3) cjenovni članak → vodič za 2026, 4) domena vodič, 5) mobilne aplikacije pillar
- **Sitemap spašen**: GSC je od 27.8. imao "Couldn't fetch" (0 stranica, nikad pročitan). Provjere: sitemap uredno servira 200 (i Googlebot UA), XML validan, robots.txt ok, čak i URL Inspection live test zelen, čisti GSC glitch. Resubmit običnog URL-a nije pomogao odmah, ali **cache-buster trik** (`sitemap.xml?v=20260831` kao novi unos) je prošao ISTOG trena: **Success, 39 discovered pages**. Stari unos ostaje dok ne pozeleni, onda obrisati ?v verziju
- **Indeksiranje: nema problema**. Pages report je star (21.8.), pa "Crawled - not indexed" lista laže; živi URL Inspection pokazuje SVE ključne stranice u indeksu: cjenovni članak, /izrada-web-stranica, Dubrovnik (s breadcrumbs), **Split (nikad requestan → Google nas otkriva sam)**, /besplatna-analiza (indeksirana za <24h!), apartmani, /usluge. "404 na /usluge" je povijesni (crawlan 16.8., prije redizajna); duplicate canonical je naslovnica sa/bez kose crte, bezopasno
- **Clutch profil kompletiran** (bio "under review", nepopunjen): web ispravljen na www kanonsku, cal.com scheduling link, opis prepisan u naš glas (bez em dasha!), **min project size $5.000 → $1.000** (stari prag bi nas izbacio iz našeg tržišta), ideal client (mali biznisi, do $10k, 1-50 zaposlenih), service lines 30/20/20/15/15 (web dev/design/video/e-comm/social = svih 5 direktorija), focus areas: JS 70/TS 30, React 40/NextJS 60, video tipovi (branded/commercial/corporate/testimonial), produkcija (filming/editing/scripting/directing), social platforme, "Other ecommerce systems" (Bruno dovršio ručno). Namjerno preskočeno: animacija, dron/podvodno, influencer, ne obećavamo što ne radimo. VAŽNO ZA CLUTCH: bez recenzija ne rangiramo na listama, uz Google review link tražiti i Clutch recenzije
- **DesignRush profil predan, "under review"**: registraciju napravio Bruno, ostalo Luka. Svi 4 koraka: podaci (2019., $35/h, min $1.000-10.000), logo generiran iz SVG-a sharpom (bijeli wordmark na #080808) i ubačen screenshot-upload trikom (localhost server + upload_image), svjež opis (ne copy-paste s Clutcha, izričito zabranjuju), 10 klijenata, 3 fotke iz ureda/studija (prve male odbijene, min 800x480, riješeno novim tabom), Zagreb adresa, 8 usluga s **Website Development #1** (drag&drop reorder), expertise (Next/React/Node, JS/TS, video, web design, SEO, social) i 8 industrija po stvarnim klijentima (sport, wellness, construction, automotive, beauty, hospitality, F&B, eCommerce)
- **Open items**:
  - DesignRush Portfolio sekcija (opcionalna, diže rang): čeka Brunove brojke - koji projekti, cjenovni rang, trajanje; Luka ubacuje za 10 min
  - **GoodFirms + Crunchbase** po istom receptu (Bruno se registrira, Luka popunjava); topseos i Sortlist kasnije
  - Za ~3-4 dana: provjeriti da je glavni sitemap unos pozelenio (pa obrisati ?v duplikat), svježi Pages report, prvi čisti Ads tjedan
  - Kad krene review-mail kampanja: tražiti Google + Clutch recenzije istim mailom
  - Content: "Koliko košta SEO optimizacija u Hrvatskoj?" je sljedeći članak (KD 5, čeka Brunov go)
- **Personal**: Dan koji je počeo s "ajmo iscijediti Semrush dok možemo", a završio s Ninefoldom prijavljenim na dva svjetska direktorija. Usput smo otkrili da je naš sitemap četiri dana visio u limbu i da ga je Google primio tek kad smo ga prošvercali s query parametrom, klasičan hack dan. Najdraži trenutak: URL po URL provjeravati indeks i gledati kako je svaka bitna stranica zelena, uključujući Split koji nitko nije ni prijavio. Google nas više ne čeka, sam nas nalazi. A za logo na DesignRushu sam morao podići lokalni server, otvoriti ga u browseru i slikati ekran da ga uopće mogu uploadati. Nije elegantno, ali je prošlo. Ekipa iz Zagreba je sad i službeno u izlogu.
