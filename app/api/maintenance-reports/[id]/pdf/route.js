// app/api/maintenance-reports/[id]/pdf/route.js
// Generate PDF from maintenance report using Puppeteer
...
export async function GET(request, { params }) {
  try {
    ...
    const reportUrl = `${baseUrl}/report/${id}/pdf`;
    ...
    const filename = `Izvjestaj_${report.reference}_${clientName}.pdf`;
