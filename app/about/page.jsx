        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 py-20">
          ...
          <div className="max-w-5xl">
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl text-[#88939D] leading-relaxed max-w-3xl mb-12"
            >
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
    ...
    <div className="max-w-4xl">
      ...
      <motion.div
        ...
        animate={storyInView ? { opacity: 1, y: 0 } : {}}
        transition={{ duration: 0.8, delay: 0.4, ease: [0.22, 1, 0.36, 1] }}
        className="space-y-6 text-lg md:text-xl text-[#88939D] leading-relaxed"
      >
        <p>
    ...
    >
      ...
      <div className="relative h-full rounded-2xl bg-transparent border-2 border-[#88939D]/20 transition-all duration-300 hover:border-[#00FF94] overflow-hidden">
        ...
        <div className="relative aspect-[3/4] bg-gradient-to-br from-[#1a1a1a] to-[#0F0F0F] overflow-hidden">
          ...
          <motion.div
            className="absolute inset-0 bg-gradient-to-br from-[#00FF94]/10 via-[#00CC78]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
            initial={false}
          />
        </div>
        ...
        {/* Content */}
        <div className="p-8">
          <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-[#00FF94] transition-colors">
            {member.name}
          </h3>
