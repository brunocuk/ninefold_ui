        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
              className="relative p-8 lg:p-10 rounded-2xl bg-transparent border-2 border-[#00FF94]/30 overflow-hidden will-change-transform"
            >
              <div className="relative z-10">
            ...
            <motion.div
              ...
              className="relative p-8 lg:p-10 rounded-2xl bg-transparent border-2 border-[#88939D]/30 overflow-hidden will-change-transform"
            >
              <div className="relative z-10">
