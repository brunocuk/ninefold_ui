      ...
      <section ref={heroRef} className="relative pt-32 pb-20 bg-[#0F0F0F] overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <motion.h1
            ...
            className="text-[clamp(2.5rem,6vw,4rem)] font-bold leading-[1.1] tracking-tight mb-6 text-white"
          >
            {post.title}
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-xl text-[#88939D] mb-8 leading-relaxed"
          >
            {post.excerpt}
          </motion.p>
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#00FF94] to-[#00CC78] relative overflow-hidden">
                {post.author.avatar && (
                  <Image
      ...
      <section className="relative py-12 bg-[#0F0F0F]">
        <div className="max-w-5xl mx-auto px-6 lg:px-12">
          <motion.div
            ...
            className="relative aspect-[16/9] rounded-2xl overflow-hidden border-2 border-[#88939D]/20"
          >
            {post.heroImage ? (
              <Image
                src={post.heroImage}
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              {post.tags.map((tag, index) => (
                <span
                  key={index}
                  className="px-4 py-2 rounded-full bg-white/5 border border-white/10 text-[#88939D] text-sm hover:border-[#00FF94]/30 hover:text-[#00FF94] transition-colors cursor-pointer"
                >
                  {tag}
                </span>
              ))}
      ...
      <section className="relative py-16 bg-[#0F0F0F] border-t border-[#88939D]/20">
        <div className="max-w-3xl mx-auto px-6 lg:px-12">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="flex items-start gap-6 p-8 rounded-2xl border-2 border-[#88939D]/20 bg-[#0F0F0F]/50"
          >
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#00FF94] to-[#00CC78] flex-shrink-0 relative overflow-hidden">
              {post.author.avatar && (
                <Image
                  src={post.author.avatar}
                  alt={post.author.name}
