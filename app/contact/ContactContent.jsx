                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span className="text-[#88939D]">Ponedjeljak - Petak</span>
                        <span className="text-white font-medium">9:00 - 17:00</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#88939D]">Vikend</span>
                        <span className="text-white font-medium">Po dogovoru</span>
                      </div>
                    </div>
                  </div>
                </motion.div>
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    <option value="" className="bg-[#0F0F0F]">Odaberite raspon budžeta</option>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Opišite nam svoj projekt, ciljeve i rokove..."
                  />
                </div>
                ...
                {submitStatus === 'success' && (
                  ...
                  >
                    Hvala na poruci! Javit ćemo vam se unutar 24 sata.
                  </motion.p>
                )}
                {submitStatus === 'error' && (
                  <motion.p
                  ...
                  >
                    Nešto je pošlo po zlu. Pokušajte ponovno ili nam pišite direktno na hello@ninefold.eu
                  </motion.p>
                )}
