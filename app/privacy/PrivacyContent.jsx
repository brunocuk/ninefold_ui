          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <div className="p-6 bg-[#1a1a1a] border-2 border-white/10 rounded-xl">
                ...
                <p className="text-[#8E8E8E] mb-2">Glavna ul. 12, 10000 Zagreb, Croatia</p>
                <p className="text-[#8E8E8E] mb-2">Email: hello@ninefold.eu</p>
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="p-6 bg-[#1a1a1a] border-2 border-white/10 rounded-xl">
                ...
                <p className="text-[#8E8E8E] mb-2">Martićeva 14, 10000 Zagreb, Croatia</p>
                <p className="text-[#8E8E8E] mb-2">Phone: +385 1 4609 000</p>
                <p className="text-[#8E8E8E]">Website: azop.hr</p>
              </div>
            </div>
