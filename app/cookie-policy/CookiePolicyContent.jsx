...
export default function CookiePolicyContent() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="relative py-32 bg-transparent overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <motion.div
            ...
            className="flex items-center gap-2 text-sm text-[#8E8E8E] mb-8"
          >
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="mb-12 p-6 bg-[#1a1a1a] border-2 border-[#00FF94]/20 rounded-xl">
              ...
              <div className="text-[#8E8E8E] space-y-2">
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc list-inside text-[#8E8E8E] space-y-2 mb-6 ml-4">
            ...
            <div className="mb-12">
              ...
              <div className="overflow-x-auto mb-8">
                <table className="w-full border-2 border-white/10 rounded-xl">
                  <thead className="bg-[#1a1a1a]">
                    <tr>
                      <th className="p-4 text-left text-white border-b-2 border-white/10">Cookie Name</th>
                      <th className="p-4 text-left text-white border-b-2 border-white/10">Purpose</th>
                      <th className="p-4 text-left text-white border-b-2 border-white/10">Duration</th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr className="border-b border-white/10">
                      ...
                      <td className="p-4 text-[#8E8E8E]">Maintains your session state</td>
                      <td className="p-4 text-[#8E8E8E]">Session</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="overflow-x-auto mb-8">
                <table className="w-full border-2 border-white/10 rounded-xl">
                  <thead className="bg-[#1a1a1a]">
                    <tr>
                      <th className="p-4 text-left text-white border-b-2 border-white/10">Cookie Name</th>
                      <th className="p-4 text-left text-white border-b-2 border-white/10">Provider</th>
                      <th className="p-4 text-left text-white border-b-2 border-white/10">Purpose</th>
                      <th className="p-4 text-left text-white border-b-2 border-white/10">Duration</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b border-white/10">
                      <td className="p-4 text-[#8E8E8E]">_ga</td>
                      <td className="p-4 text-[#8E8E8E]">Google Analytics</td>
                      <td className="p-4 text-[#8E8E8E]">Distinguishes unique users</td>
                      <td className="p-4 text-[#8E8E8E]">2 years</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="p-4 text-[#8E8E8E]">_gid</td>
                      <td className="p-4 text-[#8E8E8E]">Google Analytics</td>
                      <td className="p-4 text-[#8E8E8E]">Distinguishes unique users</td>
                      <td className="p-4 text-[#8E8E8E]">24 hours</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="p-4 text-[#8E8E8E]">_gat</td>
                      <td className="p-4 text-[#8E8E8E]">Google Analytics</td>
                      <td className="p-4 text-[#8E8E8E]">Throttles request rate</td>
                      <td className="p-4 text-[#8E8E8E]">1 minute</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="overflow-x-auto mb-8">
                <table className="w-full border-2 border-white/10 rounded-xl">
                  ...
                  <tbody>
                    <tr className="border-b border-white/10">
                      <td className="p-4 text-[#8E8E8E]">language_preference</td>
                      <td className="p-4 text-[#8E8E8E]">Stores your language choice</td>
                      <td className="p-4 text-[#8E8E8E]">1 year</td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="overflow-x-auto mb-8">
                <table className="w-full border-2 border-white/10 rounded-xl">
                  ...
                  <tbody>
                    <tr className="border-b border-white/10">
                      <td className="p-4 text-[#8E8E8E]">_fbp</td>
                      <td className="p-4 text-[#8E8E8E]">Facebook</td>
                      <td className="p-4 text-[#8E8E8E]">Tracks visits for advertising</td>
                      <td className="p-4 text-[#8E8E8E]">3 months</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="p-4 text-[#8E8E8E]">IDE</td>
                      <td className="p-4 text-[#8E8E8E]">Google</td>
                      <td className="p-4 text-[#8E8E8E]">Advertising personalization</td>
                      <td className="p-4 text-[#8E8E8E]">1 year</td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="mb-12">
              ...
              <div className="p-6 bg-[#1a1a1a] border-2 border-white/10 rounded-xl">
                <p className="text-[#8E8E8E] mb-2">
                  <strong className="text-white">Progmatiq v.l. Bruno Čukić (NineFold)</strong>
                </p>
                <p className="text-[#8E8E8E] mb-2">Glavna ul. 12, 10360 Zagreb, Croatia</p>
                <p className="text-[#8E8E8E]">Email: hello@ninefold.eu</p>
              </div>
            </div>
