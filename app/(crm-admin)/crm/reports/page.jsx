// app/(crm-admin)/crm/reports/page.jsx
// Monthly Maintenance Reports Dashboard
    ...
    <>
      ...
      <div className="reports-page">
        <div className="header">
          ...
          <p style={{ color: '#888' }}>Generiraj i šalji mjesečne izvještaje održavanja klijentima</p>

          <div className="header-actions">
            <div></div>
            <Link href="/crm/reports/new" className="btn-primary">
              + Generiraj Izvještaj
            </Link>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <p>Generiraj prvi mjesečni izvještaj za svoje klijente.</p>
            <Link href="/crm/reports/new" className="btn-primary">
                  ...
                  <div className="report-details">
                    {report.lighthouse?.performance && (
                      <div className="detail-item">
                        ...
                        <span className="detail-value highlight">{report.lighthouse.performance}</span>
                      </div>
                    )}
                    {report.analytics?.sessions && (
                      <div className="detail-item">
                        <span className="detail-label">Sesije</span>
                        <span className="detail-value">{report.analytics.sessions.toLocaleString()}</span>
                      </div>
                    )}
                    <div className="detail-item">
                    ...
                    {report.sent_at && (
                      <div className="detail-item">
                        <span className="detail-label">Poslano</span>
                        <span className="detail-value">{formatDate(report.sent_at)}</span>
                      </div>
                    )}
                  </div>

                  <div className="report-actions">
                    <Link href={`/crm/reports/${report.id}`} className="btn-small btn-view">
                    ...
                    <Link href={`/crm/reports/${report.id}?send=true`} className="btn-small btn-send">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
