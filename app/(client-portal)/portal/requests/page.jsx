...
const STATUS_CONFIG = {
  submitted: { bg: '#2A230F', color: '#FBBF24', label: 'Poslano', icon: Clock },
  in_review: { bg: '#14202E', color: '#60A5FA', label: 'Na pregledu', icon: Eye },
  in_progress: { bg: '#191D33', color: '#818CF8', label: 'U obradi', icon: Clock },
  completed: { bg: '#10291D', color: '#34D399', label: 'Završeno', icon: CheckCircle2 },
  declined: { bg: '#2C1515', color: '#F87171', label: 'Odbijeno', icon: AlertCircle },
};

const PRIORITY_CONFIG = {
  low: { bg: '#151514', color: '#8E8E8E', label: 'Nisko' },
  normal: { bg: '#14202E', color: '#60A5FA', label: 'Normalno' },
  high: { bg: '#2A230F', color: '#FBBF24', label: 'Visoko' },
  urgent: { bg: '#2C1515', color: '#F87171', label: 'Hitno' },
};
    ...
    <div>
      ...
      {filteredRequests.length === 0 ? (
        <div style={{
          ...
          <FileEdit size={48} style={{ color: '#33332F', marginBottom: '16px' }} />
          <h3 style={{
            fontSize: '1.1rem',
            fontWeight: '700',
            color: '#F2F2F2',
          ...
          <p style={{ color: '#8E8E8E', fontSize: '0.9rem', marginBottom: '20px' }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  gap: '16px',
                  padding: '20px 24px',
                  borderBottom: index < filteredRequests.length - 1 ? '1px solid #151514' : 'none',
